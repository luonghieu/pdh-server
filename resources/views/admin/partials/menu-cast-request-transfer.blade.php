@php
  ...
  $routes = [
    ...
    ['name' => 'admin.request_transfer.index', 'value' => '1次審査通過', 'url' => route('admin.request_transfer.index', ['cast_transfer_status' => App\Enums\CastTransferStatus::VERIFIED_STEP_ONE]), 'cast_transfer_status' => App\Enums\CastTransferStatus::VERIFIED_STEP_ONE],
