...
<div class="modal_wrap">
  <input id="edit_bank_accounts-error" type="checkbox">
  <div class="modal_overlay">
      <label for="edit_bank_accounts-error" class="modal_trigger" id="rating-alert-label"></label>
      <div class="modal_content modal_content-btn3">
          <div class="content-in">
              <h2 id="edit_bank_accounts-content"></h2>
          </div>
      </div>
  </div>
</div>
