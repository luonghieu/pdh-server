          ...
          <div class="leave-reason-list">
            <div class="leave-reason-list__item">
              <label class="checkbox">
                <input class="cb-cancel" type="checkbox"><span></span>サービスの使い方が分からない</label>
            </div>
            <div class="leave-reason-list__item">
              <label class="checkbox">
                <input class="cb-cancel" type="checkbox"><span></span>金額が高すぎる</label>
            </div>
            <div class="leave-reason-list__item">
              <label class="checkbox">
                <input class="cb-cancel" type="checkbox"><span></span>一緒に飲みたいキャストがいない</label>
            </div>
            <div class="leave-reason-list__item">
              <label class="checkbox">
                <input class="cb-cancel" id="textareaCheck" type="checkbox"><span></span>その他の理由</label>
            </div>
          </div>
        </div>
      </section>
