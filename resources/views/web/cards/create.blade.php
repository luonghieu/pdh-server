  ...
  <div id="form-container">
    <div id="sq-ccbox">
      ...
      <form id="nonce-form" novalidate action="/webview/card/create" method="post">
        {{ csrf_field() }}
        <input type="hidden" name="" id="square_application_id" value="{{ $squareApplicationId }}">
        <input type="hidden" name="" id="square_location_id" value="{{ $squareLocationId }}">
        <fieldset>
...
<script>
    // $( document ).ready(function() {
        ...
        var applicationId = document.getElementById('square_application_id').value;
        // Set the location ID
        var locationId = document.getElementById('square_location_id').value;
