...
return [
    ...
    'time_invalid' => "開始時間は現在時刻から30分以降の時間を選択してください",
    ...
    'invite_code_history_not_found' => '招待コードが存在しません',
    ...
    'friend_invitation_campaign_has_expired' => '友達招待キャンペーンは3/13を持ちまして' . PHP_EOL . '終了させていただきました' 
        . PHP_EOL . 'ご入力いただきましたクーポンコードは' . PHP_EOL . 'すべて無効となっております' . PHP_EOL . 'ご不明点などございましたらお問い合わせください',
];
