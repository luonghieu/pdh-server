...
class OrderResource extends Resource
{
    ...
    public function toArray($request)
    {
        ...
        return $this->filterNull([
            ...
            'temp_point' => $this->when($isCast, $this->temp_point * $cast->cost_rate, $this->temp_point),
            'total_point' => $this->when($isCast, $this->total_point * $cast->cost_rate, $this->total_point),
            ...
            'call_point' => $this->when($isCast, $this->call_point * $cast->cost_rate, $this->call_point),
            'nominee_point' => $this->when($isCast, $this->nominee_point * $cast->cost_rate, $this->nominee_point),
